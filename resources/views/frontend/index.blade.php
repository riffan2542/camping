...
<head>
    ...
    <!--=== Slicknav CSS ===-->
    <link href="frontend/assets/css/plugins/slicknav.min.css" rel="stylesheet">
    <!--=== Magnific Popup CSS ===-->
    <link href="frontend/assets/css/plugins/magnific-popup.css" rel="stylesheet">
    <!--=== Owl Carousel CSS ===-->
    <link href="frontend/assets/css/plugins/owl.carousel.min.css" rel="stylesheet">
    <!--=== Gijgo CSS ===-->
    <link href="frontend/assets/css/plugins/gijgo.css" rel="stylesheet">
    <!--=== FontAwesome CSS ===-->
    <link href="frontend/assets/css/font-awesome.css" rel="stylesheet">
    <!--=== Theme Reset CSS ===-->
    <link href="frontend/assets/css/reset.css" rel="stylesheet">
    <!--=== Main Style CSS ===-->
    <link href="frontend/style.css" rel="stylesheet">
    <!--=== Responsive CSS ===-->
    <link href="frontend/assets/css/responsive.css" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="{{ asset('awesome/css/fontawesome.min.css') }}">
    ...
    <div class="preloader">
        <div class="preloader-spinner">
            <div class="loader-content">
                <img style="height:400px;width:400px;" src="frontend/assets/img/fire.gif" alt="JSOFT">
            </div>
        </div>
    </div>
    <!--== Preloader Area End ==-->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <a href="index.html" class="logo">
                            <img src="frontend/assets/img/logo2.png" alt="JSOFT">
                        </a>
                    </div>
                    <!--== Logo End ==-->
                ...
                <div class="col-lg-12 text-center">
                    <div class="partner-content-wrap">
                        ...
                        <div class="single-partner">
                            <div class="display-table">
                                <div class="display-table-cell">
                                    <img src="frontend/assets/img/partner/partner-logo-1.png" alt="JSOFT">
                                </div>
                            </div>
                        </div>
                        <!-- Single Partner End -->
                        ...
                        <div class="single-partner">
                            <div class="display-table">
                                <div class="display-table-cell">
                                    <img src="frontend/assets/img/partner/partner-logo-2.png" alt="JSOFT">
                                </div>
                            </div>
                        </div>
                        <!-- Single Partner End -->
                        ...
                        <div class="single-partner">
                            <div class="display-table">
                                <div class="display-table-cell">
                                    <img src="frontend/assets/img/partner/partner-logo-3.png" alt="JSOFT">
                                </div>
                            </div>
                        </div>
                        <!-- Single Partner End -->
                        ...
                        <div class="single-partner">
                            <div class="display-table">
                                <div class="display-table-cell">
                                    <img src="frontend/assets/img/partner/partner-logo-4.png" alt="JSOFT">
                                </div>
                            </div>
                        </div>
                        <!-- Single Partner End -->
                        ...
                        <div class="single-partner">
                            <div class="display-table">
                                <div class="display-table-cell">
                                    <img src="frontend/assets/img/partner/partner-logo-5.png" alt="JSOFT">
                                </div>
                            </div>
                        </div>
                        <!-- Single Partner End -->
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="section-title  text-center">
                        <h2>Our Services</h2>
                        <span class="title-line"><i class="fa fa-free-code-camp" aria-hidden="true"></i>></span>
    ...
    <section id="choose-car" class="section-padding">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="section-title  text-center">
                        <h2>Choose Your Camping Tool</h2>
                        <span class="title-line"><i class="fa fa-free-code-camp" aria-hidden="true"></i></span>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="choose-content-wrap">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="home-tab" data-toggle="tab" href="#popular_cars" role="tab" aria-selected="true">Camping Tool</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="contact-tab" data-toggle="tab" href="#office_map" role="tab" aria-selected="false">Our Place</a>
                            </li>
                        </ul>
                        <!-- Choose Area Tab Menu -->
                                            ...
                                            <div class="single-new-car">
                                                <div class="p-car-thumbnails">
                                                    <a class="car-hover" href="assets/img/car/car-6.jpg">
                                                      <img src="frontend/assets/img/car/car-6.jpg" alt="JSOFT">
                                                   </a>
                                                </div>
                                            ...
                                            <div class="single-new-car">
                                                <div class="p-car-thumbnails">
                                                    <a class="car-hover" href="assets/img/car/car-5.jpg">
                                                      <img src="frontend/assets/img/car/car-5.jpg" alt="JSOFT">
                                                   </a>
                                                </div>
                                            ...
                                            <div class="single-new-car">
                                                <div class="p-car-thumbnails">
                                                    <a class="car-hover" href="assets/img/car/car-4.jpg">
                                                      <img src="frontend/assets/img/car/car-4.jpg" alt="JSOFT">
                                                   </a>
                                                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="section-title  text-center">
                        ...
                        <span class="title-line"><i class="fa fa-free-code-camp" aria-hidden="true"></i></i></span>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
                    </div>
                </div>
                <!-- Section Title End -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5">
                                <div class="article-thumb">
                                    <img src="frontend/assets/img/gambar5.jpg" alt="JSOFT">
                                </div>
                            </div>
                    ...
                    <article class="single-article middle">
                        <div class="row">
                            ...
                            <div class="col-lg-5 d-xl-none">
                                <div class="article-thumb">
                                    <img src="frontend/assets/img/article/arti-thumb-2.jpg" alt="JSOFT">
                                </div>
                            </div>
                            <!-- Articles Thumbnail End -->
                            ...
                            <div class="col-lg-5 d-none d-xl-block">
                                <div class="article-thumb">
                                    <img src="frontend/assets/img/camping2.jpg" alt="JSOFT">
                                </div>
                            </div>
                            <!-- Articles Thumbnail End -->
                        </div>
                ...
                <div class="col-lg-12">
                    <article class="single-article">
                        <div class="row">
                            ...
                            <div class="col-lg-5">
                                <div class="article-thumb">
                                    <img src="frontend/assets/img/camping.jpg" alt="JSOFT">
                                </div>
                            </div>
                            <!-- Articles Thumbnail End -->
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
    ...
    <!--=== Gijgo Min Js ===-->
    <script src="frontend/assets/js/plugins/gijgo.js"></script>
    <!--=== Vegas Min Js ===-->
    <script src="frontend/assets/js/plugins/vegas.min.js"></script>
    <!--=== Isotope Min Js ===-->
    ...
    <!--=== CounTotop Min Js ===-->
    <script src="frontend/assets/js/plugins/counterup.min.js"></script>
    <!--=== YtPlayer Min Js ===-->
    <script src="frontend/assets/js/plugins/mb.YTPlayer.js"></script>
    <!--=== Magnific Popup Min Js ===-->
    <script src="frontend/assets/js/plugins/magnific-popup.min.js"></script>
    <!--=== Slicknav Min Js ===-->
    <script src="frontend/assets/js/plugins/slicknav.min.js"></script>
